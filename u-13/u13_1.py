...
def u13_1_2():
    ...
    Die Werte hier im Vergleich zu u13.1.1 sind sehr stabil, besonders bei 10**6 Schüssen. Hier sieht man, dass es sehr schnell konvergiert.
    In u13.1.1 selbst bei 10**6 Schüssen haben die Werte immer noch hohe Schwankungen.
    '''   
